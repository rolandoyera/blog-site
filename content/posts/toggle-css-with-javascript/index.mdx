...
Open your developer console in Chrome (or the browser of choice) and toggle the button to see the effect logged in the console. Notice how the CSS class changes.
