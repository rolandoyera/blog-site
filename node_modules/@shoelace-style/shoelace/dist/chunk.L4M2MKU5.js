...
// _ccwmwdlsd:/Users/claviska/Projects/shoelace/src/components/menu-divider/menu-divider.scss
...
var SlMenuDivider = class extends Shoemaker {
  render() {
    return html` <div part="base" class="menu-divider" role="separator" aria-hidden="true" /> `;
  }
};
SlMenuDivider.tag = "sl-menu-divider";
SlMenuDivider.styles = menu_divider_default;
