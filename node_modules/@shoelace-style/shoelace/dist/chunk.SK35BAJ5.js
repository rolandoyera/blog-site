...
// _ccwmwdlsd:/Users/claviska/Projects/shoelace/src/components/color-picker/color-picker.scss
...
var SlColorPicker = class extends Shoemaker {
  constructor() {
    super(...arguments);
    this.alpha = 100;
...
SlColorPicker.tag = "sl-color-picker";
SlColorPicker.props = [
  "inputValue",
  "hue",
  "saturation",
...
SlColorPicker.reflect = ["disabled", "invalid"];
SlColorPicker.styles = color_picker_default;
