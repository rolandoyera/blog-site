...
// _ccwmwdlsd:/Users/claviska/Projects/shoelace/src/components/spinner/spinner.scss
...
var SlSpinner = class extends Shoemaker {
  render() {
    return html` <span part="base" class="spinner" aria-busy="true" aria-live="polite"></span> `;
  }
};
SlSpinner.tag = "sl-spinner";
SlSpinner.styles = spinner_default;
